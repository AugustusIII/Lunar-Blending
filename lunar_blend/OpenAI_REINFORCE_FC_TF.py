...
class OpenAI_REINFORCE_FC():
    ...
    def REINFORCE_FC_Setup(self):
        ...
        with tf.name_scope('inputs'):
            ...
            self.tf_observations = tf.placeholder(tf.float32, [None, self.num_observations], name = 'observations')
    ...
    def REINFORCE_FC_Train(self):
        ...
        if self.episode == 0:
            ...
            fhand.write('NUM_FEATURES\t' + str(self.num_observations) + '\n')
